...
%
% AFFILIATION.  IEEE journals require one. Put it in \authoraffiliation below,
% e.g. {Department of Computer Science and Engineering, <College>, <City>,
% India}. While it is empty the first-page footnote names the corresponding
% author only, so the PDF never prints a placeholder.
