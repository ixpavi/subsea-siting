...
Evaluation on 355 As-Laid Routes}
...
were actually laid. We test it on \nCorpusRoutes{} as-laid routes
(\nCorpusKm{}\,km) republished by seven national hydrographic offices, against
bathymetry at 460\,m and 1.85\,km. Three controls carry the evaluation: a
...
excluded rather than interpolated over, leaving 355 routes.
...
locates it at the landfalls rather than along the route.}
\label{fig:fishing}
\end{figure}
